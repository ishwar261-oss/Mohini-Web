...
const sequences = [
    ...
    {
        cmd: "/idea startup AI",
        response: "## Idea 1: AI-Driven Health Tutor\n**Description:** Personalized learning paths based on biometric data.\n**Potential Value:** Increases retention by 40%.\n**Challenges:** Data privacy and regulation.",
        type: "ai",
    },
    {
        cmd: "/plan build a mobile app",
        response: "# Action Plan: Build App\n## Phase 1: Planning\n- Market Research\n- UI Mockups",
        type: "ai",
    },
    {
        cmd: "/analyze",
    ...
    {
        cmd: "What are the latest AI trends?",
        response: "Trends include LLM efficiency, multi-modal agents,\nand AI safety/alignment protocols.",
        type: "ai",
    },
];

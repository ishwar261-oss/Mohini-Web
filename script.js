...
const sequences = [
    {
        cmd: "/code Python Fibonacci sequence",
        response: "```python\ndef fib(n):\n    a, b = 0, 1\n    for _ in range(n):\n        yield a\n        a, b = b, a+b```",
        type: "ai",
    },
    {
    ...
    {
        cmd: "/todo add Review PR by 5pm",
        response: "✓ Task added: 'Review PR by 5pm'",
        type: "success",
    },
    {
        cmd: "Explain how transformers work",
        response: "Transformers use self-attention to process\nsequences in parallel. Each token attends\nto every other token with learned weights...",
        type: "ai",
    },
    {
        cmd: "/reminder 15 Stand up meeting",
        response: "⏰ Reminder set for 15 minutes.",
        type: "success",
    },
];
